...
function abrirVentana(url) {
  ...
  function initializeSlider(){
    if(slides.length > 0){
        ...
        intervalId = setInterval(nextSlide, 5000); // After 5 seconds
    }
  }

  function showSlide(index) {
    slideIndex = (index + slides.length) % slides.length; // Adjusting index to be within range
  ...
  function nextSlide(){
    ...
    window.addEventListener('scroll', function() {
        ...
        if (window.scrollY > 50) { // Cambia 100 por la cantidad de desplazamiento que desees
